  ...
  private HttpStatus determineHttpStatus(DiscodeitException exception) {
    ...
    return switch (errorCode) {
      case USER_NOT_FOUND, CHANNEL_NOT_FOUND, MESSAGE_NOT_FOUND, BINARY_CONTENT_NOT_FOUND,
           READ_STATUS_NOT_FOUND, NOTIFICATION_NOT_FOUND, USER_STATUS_NOT_FOUND -> HttpStatus.NOT_FOUND;
      case DUPLICATE_USER, DUPLICATE_READ_STATUS, BINARY_CONTENT_DUPLICATE,
           DUPLICATE_USER_STATUS -> HttpStatus.CONFLICT;
      case INVALID_USER_CREDENTIALS, INVALID_TOKEN, INVALID_USER_DETAILS -> HttpStatus.UNAUTHORIZED;
      case PRIVATE_CHANNEL_UPDATE, INVALID_REQUEST, INVALID_PASSWORD -> HttpStatus.BAD_REQUEST;
